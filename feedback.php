...
<body>
    ...
    <div class="hero">
            <div class="content">
                <h2>We value all the feedback</h2>
                <p>We value feedback, please rate your experience below. Thank you for helping us improve our service.</p>
                <button class="btn"><a href="rate.html">Rate Us</a></button>
            </div>
